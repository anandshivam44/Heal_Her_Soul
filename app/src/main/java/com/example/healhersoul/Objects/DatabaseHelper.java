...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table "+TABLE_NAME+"(DATE INTEGER ,MONTH INTEGER,YEAR INTEGER)");
    ...
    public boolean insertData(Integer date,Integer month,Integer year) // this method is used to insert data in table.
    {
